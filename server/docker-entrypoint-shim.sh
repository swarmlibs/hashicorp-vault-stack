...
{
    echo '# This file is generated by /docker-entrypoint-shim.sh'
    echo 'storage "raft" { '
    seq ${VAULT_STACK_REPLICAS:-1} | xargs -I {} echo "  retry_join { leader_api_addr = \"http://replica-{}.vault-internal:8200\" } "
    echo '}'
